...
public class DoctorAI : MonoBehaviour, IEnemy
{
    ...
    public float shieldDelay = 10f;

    private float _specialAttackTimer = 0;
    public float specialAttackDelay = 2;
    ...
    void Start()
    {
        ...
        _enemyCharacter.SetShieldActive(true);
    ...
    void Update()
    {
        ...
        if(_shieldTimer > shieldDelay)
        {
            ...
            _enemyCharacter.SetShieldActive(_isShieldActive);
            _shieldTimer = 0;
        }
